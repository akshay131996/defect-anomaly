...
| REF-official-256 | 2026-09-06T03:28:00+02:00 | squash | 256 (official ensemble) | 0.2059 | 0.677 | `794a846` | **supports split isolation** — official Amazon PatchCore Ensemble (WRN-101 + ResNeXt-101 + DenseNet-201, 1024->384 pooling, 1% uncapped) evaluated on test_public scores 0.2059 mean AU-PRO@5% (vs 0.288 published on test_private). Proves the 8.2-pt gap is an eval split difference, NOT an implementation defect. On test_public, our single WRN-50 pipeline (0.2221) actually beats the official ensemble by +0.0162. Active regs: 1524/1530. Wall 697.9s. |
| REF-official-512 | 2026-09-06T18:45:00+02:00 | squash | 512 (official ensemble) | 0.3108 | 0.706 | `1795e1c` | **supports resolution scaling on split** — official Amazon PatchCore Ensemble at 512x512 on test_public scores 0.3108 mean AU-PRO@5% (vs 0.4190 published on test_private). Confirms split effect at 512 is -10.82 points. Every scenario improves over 256 (+0.1049 mean gain; fabric jumps 4.7x to 0.2790, wallplugs 3.1x to 0.2622). Our single WRN-50 pipeline at 448 aspect (E4b, 0.3444) beats official 512 by +3.36 points. Active regs: 1524/1530. Wall 3847.0s. |
| REF-official-halfnative | 2026-09-06T20:50:00+02:00 | squash | halfnative (official ensemble) | partial (`can`: 0.2359) | — | `7465313` | **partial / OOM on 16GB GPU** — scenario 1 (`can`) completed cleanly (AU-PRO@5% 0.2359 vs 0.1433 @512, +64.6%; Pix AUROC 0.8135 vs 0.7410). Scenario 2 (`fabric` @ 1224x1024) exceeded 16GB VRAM (15.55 GiB in use during greedy coreset distance matrix mm). Confirms un-chunked greedy coreset memory ceiling on standard 16GB GPUs. REF-512 stands as accepted upper reference ceiling. |
...
| REF-official-512 | 2026-09-06T18:45+02:00 | squash | 512 | **0.3108** | 0.706 | official repo | **complete** — official code on test_public; split effect -10.8; ours at 448 (0.3444) beats it by +3.4 |
